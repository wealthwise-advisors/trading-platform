...
OHLCV_AGG = OrderedDict((
    ...
    ('DATE', 'max'),
    ('DivergenceInfo', 'max'),
    ('BuySellConditions', 'max'),
    ('Yellow_Swing_Volume', 'max'),
    ('Blue_Swing_Volume', 'max'),
    ('Yellow_Average_Swing_Volume', 'max'),
    ('Yellow_Body_Average_Swing_Volume', 'max'),
    ('Blue_Average_Swing_Volume', 'max'),
    ('One_SD_Top', 'sum'),
    ('One_SD_Bottom', 'sum'),
    ('Two_SD_Top', 'sum'),
    ('Two_SD_Bottom', 'sum'),
