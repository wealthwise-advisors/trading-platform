...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'third_party'))
...
def check_for_trading(row):
    ...
    if is_between(defs.ASIA_MARKET_START_TIME, defs.ASIA_MARKET_END_TIME, target_time):
        return defs.PERFORM_TRADING_ASIA
    elif is_between(defs.EUROPE_MARKET_START_TIME, defs.EUROPE_MARKET_END_TIME, target_time):
        return defs.PERFORM_TRADING_EUROPE
    elif is_between(defs.USA_MARKET_START_TIME, defs.USA_MARKET_END_TIME, target_time):
        return defs.PERFORM_TRADING_USA
    else:
        return 0
...
class RSIStochExtremeStrategy(Strategy):
    ...
    def next(self):
        ...
        if self.data.TRADE[-1] == 1:
            ...
            if "10:13 AM" in self.current_candle.date:
                print("Put Break Point")
            ...
            for i in range(0, 2):
                ...
                if not self.in_trade and buy_condition:
                    ...
                    stop_limit_price = stop_loss - defs.STOP_LOSS_ADJUST
                    if self.enable_trade_buying:
                        self.buy(sl=stop_limit_price, size=defs.PROFIT_FOR_ONE_POINT)
                    self.buy_order = True
                    self.in_trade = True
                ...
                if not self.in_trade and short_condition:
                    try:
                        ...
                        if self.enable_trade_shorting:
                            self.sell(sl=stop_limit_price,  size=defs.PROFIT_FOR_ONE_POINT)
...
#Choppy Dates
# dates_list = [
#     "2024-01-05", "2024-01-11", "2024-01-24", "2024-02-02", "2024-02-05", "2024-04-08",
#     "2024-02-23", "2024-03-06", "2024-03-14", "2024-03-26", "2024-04-03", "2024-04-09",
#     "2024-04-16", "2024-04-18", "2024-04-26", "2024-04-29", "2024-05-01", "2024-05-21",
#     "2024-06-04", "2024-06-07", "2024-06-14", "2024-03-11", "2024-02-27", "2024-03-13",
#     "2024-07-25", "2024-06-26", "2024-08-12", "2024-08-20", "2024-08-27", "2024-09-04",
#     "2024-08-21", "2024-07-23", "2024-08-05", "2024-08-16", "2024-07-29", "2024-07-15",
#     "2024-07-09", "2024-07-01", "2024-06-28", "2024-06-21", "2024-06-11", "2024-06-06",
#     "2024-06-03", "2024-05-28", "2024-05-20", "2024-05-13", "2024-05-08", "2024-01-12",
#     "2024-05-10", "2024-04-01", "2024-01-09", "2024-01-16", "2024-01-26", "2024-02-08",
#     "2024-03-25", "2022-07-22", "2022-07-21", "2022-07-25", "2022-08-04", "2022-08-05",
#     "2022-08-08", "2022-08-11", "2022-08-18", "2022-09-01", "2022-09-27", "2022-10-01",
#     "2022-11-03", "2022-10-26", "2022-11-23", "2022-12-22", "2022-12-14", "2023-01-12",
#     "2023-01-09", "2023-01-18", "2023-02-08", "2023-02-10", "2023-02-14", "2023-02-22",
#     "2023-01-23", "2023-03-13", "2023-03-15", "2023-04-11", "2023-04-21", "2023-05-08",
#     "2023-06-05", "2023-06-30", "2023-07-21", "2023-07-10", "2023-08-10", "2023-08-18",
# ]

#2022 Top Losses
# dates_list = [
#     "2022-05-12", "2022-05-31", "2022-06-17", "2022-06-29",
#     "2022-07-06", "2022-05-11", "2022-11-16", "2022-10-31",
#     "2022-09-22", "2022-10-19", "2022-01-26", "2022-09-14",
#     "2022-09-06", "2022-11-01", "2022-08-01", "2022-11-23",
#     "2022-10-12"
# ]
...
# dates_list = [
#     "2024-01-19", "2024-01-23", "2024-01-29", "2024-01-31",
#     "2024-02-01", "2024-02-07", "2024-02-14", "2024-02-22",
#     "2024-02-29", "2024-03-01", "2024-03-07", "2024-03-15",
#     "2024-03-19", "2024-03-20", "2024-04-04", "2024-04-15",
#     "2024-04-22", "2024-04-25",  "2024-05-15",
#     "2024-06-11", "2024-07-02", "2024-07-08", "2024-07-18",
#     "2024-07-24", "2024-07-25", "2024-08-02"
# ]

#2023 Top Losses
# dates_list = [
#     "2023-05-04", "2023-01-05", "2023-02-14", "2023-02-10",
#     "2023-12-05", "2023-03-17", "2023-01-19", "2023-06-09",
#     "2023-03-20", "2023-08-03", "2023-10-24", "2023-10-27",
#     "2023-01-03", "2023-04-21", "2023-05-24", "2023-02-06",
#     "2023-10-20", "2023-02-02", "2023-05-08", "2023-08-25",
#     "2023-07-28"
# ]

#Highest Loses in 2022. 2023 and 2024
# dates_list = [
#     "2024-08-01","2024-08-08","2024-04-19","2024-04-16","2024-04-12","2024-02-23","2024-04-18","2024-09-03","2024-03-15","2024-06-06",
#     "2022-11-02","2022-09-21","2022-10-14","2022-05-12","2022-11-04","2022-08-30","2022-01-26","2022-04-26","2022-08-26","2022-09-06",
#     "2023-08-04","2023-03-10","2023-08-10","2023-10-13","2023-10-20","2023-10-19","2023-10-12","2023-06-28","2023-10-06","2023-08-24"
# ]
...
#dates_list =  ["2025-04-07", "2024-08-23", "2025-03-25", "2025-01-27", "2025-03-18", "2025-03-11", "2025-03-05", "2025-04-11", "2025-04-10", "2025-04-09", "2023-05-16", "2023-02-08", "2023-05-26", "2023-01-09", "2023-01-03", "2023-09-20", "2024-08-16", "2022-10-24", "2022-03-10", "2022-02-14", "2022-07-06", "2022-02-24", "2022-01-06", "2022-10-12", "2022-03-09", "2024-12-19", "2024-06-03", "2024-08-02", "2024-10-03", "2024-08-05", "2024-09-04"]

#dates_list = ["2025-02-28", "2025-03-11", "2025-03-05", "2025-06-18", "2025-06-04", "2025-04-07", "2025-04-09", "2025-04-10", "2025-04-11", "2025-04-08"]

#dates_list = ["2024-09-04", "2024-08-05", "2024-06-03", "2024-07-31", "2024-08-16", "2024-07-25", "2024-08-06", "2024-11-20", "2024-09-11", "2024-12-18"]

#dates_list = ["2022-03-09", "2022-10-12", "2022-01-06",  "2022-02-24", "2022-05-09", "2022-03-08", "2022-10-13", "2022-01-27", "2022-02-28", "2022-11-08 "]

dates_list = ["2021-07-29"]

# dates_list = ["2025-10-16", "2025-10-17", "2025-10-21", "2025-10-22", "2025-10-29", "2025-10-31", "2025-11-06", "2025-11-07", "2025-11-11", "2025-11-12", "2025-11-18", "2025-11-21", "2025-11-24"]

# dates_list = [
#     "2025-04-07", "2025-04-11", "2025-04-10", "2025-04-09", "2025-04-25",
#     "2025-04-08", "2025-04-17", "2025-05-08", "2025-04-23", "2025-04-01",
#     "2025-05-15", "2025-04-21", "2025-03-28", "2025-05-05", "2025-04-24",
#     "2025-04-03", "2025-04-04", "2025-04-15", "2025-06-03", "2025-05-07",
#     "2025-06-05", "2025-05-21", "2025-05-16", "2025-06-12", "2025-05-12",
#     "2025-03-31", "2025-05-19", "2025-06-11", "2025-03-27", "2025-05-28",
#     "2025-05-22", "2025-06-02", "2025-04-16", "2025-05-01", "2025-05-14",
#     "2025-06-13", "2025-05-30", "2025-04-30", "2025-05-26", "2025-06-10"
# ]


# dates_list = [
#     "2025-03-27", "2025-03-28", "2025-04-02", "2025-04-04", "2025-04-07",
#     "2025-04-08", "2025-04-11", "2025-04-14", "2025-04-15", "2025-04-21",
#     "2025-04-22", "2025-04-23", "2025-04-28", "2025-04-29", "2025-05-01",
...
df_main = utility.load_historical_data("C:\Data\ES_FULL.csv")
# Convert index to datetime (only once for efficiency)
if not isinstance(df_main.index, pd.DatetimeIndex):
    df_main.index = pd.to_datetime(df_main.index)

for run_date in dates_list:
    divergence_swing_collection.clear()
    updated_divergences.clear()
    buying_shorting_conditions.clear()
    start_date = datetime.strptime(run_date, "%Y-%m-%d")
    num_days = 1  # Approximate number of weekdays in a year

    weekdays = generate_dates(start_date, num_days)

    for date in weekdays:
        if   date == '2023-12-23' or  date == '2024-07-04' or date == '2021-07-05' or date == '2021-09-06' or date == '2021-02-15' or date == '2024-07-01' or  date == '2023-07-04' or  date == '2023-11-23' or  date == '2024-09-18' or  date == '2023-03-22':
            continue
        try:
            one_previous_day = get_previous_working_day(date)
            market_open_time = date + ' 07:00:00'
            default_market_close_time = date + ' 16:00:00'  # Default close time
            df_date = df_main[df_main.index.date == pd.to_datetime(date).date()]
            if not df_date.empty:
                current_day = date
                # Ensure df_date index is in datetime format
                df_date.index = pd.to_datetime(df_date.index)

                # Determine actual market close time dynamically
                actual_market_close_time = df_date.index.max() if (df_date.index >= pd.to_datetime(market_open_time)).any() else pd.to_datetime(default_market_close_time)

                # Get up to 60 pre-market candles (before 09:30)
                df_pre_market = df_date[df_date.index < pd.to_datetime(market_open_time)].tail(60)

                # Get market hours candles (from 09:30 to actual close time)
                df_market_hours = df_date[(df_date.index >= pd.to_datetime(market_open_time)) &
                                          (df_date.index <= actual_market_close_time)]

                # Combine both DataFrames
                df = pd.concat([df_pre_market, df_market_hours])
                ...
                entry_signal_rows = df.copy()
                highest_price_index = entry_signal_rows['High'].idxmax()
                lowest_price_index = entry_signal_rows['Low'].idxmin()
                stop_loss_high = entry_signal_rows['High'].max()
                stop_loss_low = entry_signal_rows['Low'].min()
                df = apply_rsi_stoch_doji(df)
                print(df[['Open', 'High', 'Low', 'Close', 'Volume', 'RSI', 'STOCH', 'STOCH_D', 'RSI_13']].head())
                #df.to_csv(f'04_15_OHLC.csv', index=False)
                count_above_94 = df[df['RSI'] > 94].shape[0]
                # Count of RSI values less than 5
                count_below_5 = df[df['RSI'] < 5].shape[0]
                # Print the results
                first_index = entry_signal_rows.index[0]
                #generate_fibonacci_sequence(df, first_index, False, True)
                last_index = df.index[-1]
                #df["CLOSE_OPEN_OPEN"] = df.apply(lambda row: apply_fib_text(row, "LOW"), axis=1)
                #df["GREEN_WICK_VOLUME_UP_DOWN"] = df.apply(apply_green_wick_volume_up_down_text, axis=1)
                #df["RED_WICK_VOLUME_UP_DOWN"] = df.apply(apply_red_wick_volume_up_down_text, axis=1)
                #df["GREEN_WICK_UP_DOWN"] = df.apply(apply_green_wick_up_down_text, axis=1)
                #df["RED_WICK_UP_DOWN"] = df.apply(apply_red_wick_up_down_text, axis=1)
                #df["Elliot_Wave_3"] = 0
                df["Elliot_Wave_10"] = 0
                df["KAMA"] = 0
                #df["IS_FLAT"] = 0

                if count_above_94 > (count_below_5 + .25 * count_below_5):
                    enable_trade_buying = True
                    enable_trade_shorting = False
                elif count_below_5 > (count_above_94 + .25 * count_above_94):
                    enable_trade_buying = False
                ...
                divergence_series = pd.Series({
                    ts: "<br>".join([
                        f"<b>Trade Type:</b> {div.trade_type} | <b>Extreme:</b> {div.is_extreme} | <b>Pre-Condition:</b> {div.is_pre_condition} | <b>RSI 13:</b> {div.is_rsi_13} | <b>Artificial:</b> {div.is_artificial_divergence} <br>"
                ...
                def format_conditions(value):
                    if value is None:
                        ...
                        return "<br>".join(map(str, value))  # Ensure list elements are strings
                ...
                buying.append(enable_trade_buying)
                shorting.append(enable_trade_shorting)
                print(stats)
                back_test_results.append(stats)
            fileName = 'strategy_six_info_only_' + date
            bt.plot(filename=utility.get_file_name(fileName)[0], divergence_swing_collection=list(divergence_swing_collection.values()))
        except Exception as Ex:
            print(f'Error during processing {Ex}')
            traceback.print_exc()

columns_to_keep = ["Start", "End", "Equity Final [$]", "Equity Peak [$]", "Return [%]", "# Trades", "Best Trade [%]", "Worst Trade [%]"]
results = pd.DataFrame(back_test_results)
results = results[columns_to_keep]
results.rename(columns={'Equity Final [$]': 'Final', 'Equity Peak [$]': 'Peak', '# Trades': 'Trades', 'Best Trade [%]': 'Best', 'Worst Trade [%]': 'Worst'}, inplace=True)
results['Profit'] = results.apply(calculate_profit, axis=1)
results['Only_Buying'] = buying
results['Only_Shorting'] = shorting
file_name = 'STRATEGY_SIX_2025_'
current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
file_name_with_time = f"{file_name}_{current_time}"
condition_df = pd.DataFrame(all_conditions_store)
#condition_df.to_csv(f"all_condtions_{current_time}.csv", index=False)
#results.to_excel(excel_writer=utility.get_file_name(file_name_with_time)[1])