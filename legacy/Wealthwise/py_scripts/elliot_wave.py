...
def fetch_data():
    ...
    start_date = (datetime.now() - timedelta(days=3)).date() #.date() not required for yfinacne, but required for schdev API
    ...
    # data = yf.download(symbol, start=start_date,interval='1m')
    ...
    # df2.to_csv(r"C:\Users\HP\Downloads\es_f_data_yfinance.csv")
    ...
    # data = pd.read_csv(r"C:\Users\HP\Downloads\run_time_error_data_set_one.csv")
...
update_chart(fetch_data, interval="1min")
