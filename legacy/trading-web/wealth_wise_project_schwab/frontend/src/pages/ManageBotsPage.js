  ...
  return (
    <div className="bg-white shadow-md rounded p-6">
      ...
      <table className="w-full border-collapse border border-gray-300 mb-6">
        <thead>
          <tr className="bg-gray-200">
            ...
            <th className="border border-gray-300 p-2">Buying</th>
            <th className="border border-gray-300 p-2">Shorting</th>
          ...
          {bots.map((bot) => (
            <tr key={bot.bot_id} className="text-center">
              ...
              <td className="border border-gray-300 p-2">{bot.strategy}</td>
               ...
               <td className={`border border-gray-300 p-2 font-bold ${bot.enable_trade_buying ? 'text-green-500' : 'text-red-500'}`}>{bot.enable_trade_buying ? "Yes" : "No"}</td>
               <td className={`border border-gray-300 p-2 font-bold ${bot.enable_trade_shorting ? 'text-green-500' : 'text-red-500'}`}>{bot.enable_trade_shorting ? "Yes" : "No"}</td>
      ...
      <div className="grid grid-cols-4 gap-4 mt-6">
        ...
        <button onClick={() => handleAction("ENABLE_TRADING_BUYING")} className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">ENABLE TRADE BUYING</button>
        <button onClick={() => handleAction("DISABLE_TRADING_BUYING")} className="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">DISABLE TRADE BUYING</button>
        <button onClick={() => handleAction("ENABLE_TRADING_SHORTING")} className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">ENABLE TRADE SHORTING</button>
        <button onClick={() => handleAction("DISABLE_TRADING_SHORTING")} className="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">DISABLE TRADE SHORTING</button>
