                ...
                for i in range(0, 2):
                    ...
                    if not self.in_trade and buy_condition:
                        try:
                            ...
                            logging.info(f"{self.symbol_ironbeam} :Placed Buy Order with Stop Limit {stop_loss}")
                    ...
                    if not self.in_trade and short_condition:
                        try:
                            ...
                            self.in_trade = True
                            self.in_trade_candle = current_candle
                            logging.info(f"{self.symbol_ironbeam} :Placed Short Order with Stop Limit {stop_loss}")
                        except Exception as e:
